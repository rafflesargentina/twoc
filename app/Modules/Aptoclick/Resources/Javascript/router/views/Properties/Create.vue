            ...
            <div class="col-lg-7 ml-auto">
              ...
              <div class="form-group">
                ...
                <input
                  id="autocomplete"
                  v-validate.disabled="'required'"
                  :class="{ 'is-invalid': errors.first('autocomplete') }"
                  name="autocomplete"
                  class="form-control"
                  @input="geolocate"
                >
...
export default {
    ...
    watch: {
        "$route" (value) {
            if (value.name === "PropertiesCreate" && this.prepared) {
                this.prepare()
            }
        },
    ...
    methods: {
        ...
        prepare() {
            ...
            return Promise.all([amenities, facilities, propertyConditions, propertyTypes])
        },
